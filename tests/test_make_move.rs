...
mod test_moves {
    ...
    fn make_move_starting() {
        ...
        let inputs = [
            // pawns (2 squares)
            ("A2->A4", "rnbqkbnr/pppppppp/8/8/P7/8/1PPPPPPP/RNBQKBNR b KQkq a3 0 1"),
            ("B2->B4", "rnbqkbnr/pppppppp/8/8/1P6/8/P1PPPPPP/RNBQKBNR b KQkq b3 0 1"),
            ("C2->C4", "rnbqkbnr/pppppppp/8/8/2P5/8/PP1PPPPP/RNBQKBNR b KQkq c3 0 1"),
            ("D2->D4", "rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1"),
            ("E2->E4", "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1"),
            ("F2->F4", "rnbqkbnr/pppppppp/8/8/5P2/8/PPPPP1PP/RNBQKBNR b KQkq f3 0 1"),
            ("G2->G4", "rnbqkbnr/pppppppp/8/8/6P1/8/PPPPPP1P/RNBQKBNR b KQkq g3 0 1"),
            ("H2->H4", "rnbqkbnr/pppppppp/8/8/7P/8/PPPPPPP1/RNBQKBNR b KQkq h3 0 1"),
    ...
    fn make_move_starting_ep1() {
        ...
        let mv = "F5->E6"; // ep.
        pos.make_move(Move::from_ascii(mv));
    ...
    fn make_move_starting_ep() {
        ...
        let result_fen = "8/8/8/8/8/4p3/8/8 w KQkq - 0 1";
        assert_eq!(pos.to_fen(), result_fen);
    }
